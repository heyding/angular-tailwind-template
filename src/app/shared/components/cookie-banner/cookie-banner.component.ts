...
@Component({
  ...
  template: `
    @if (showBanner()) {
      <div
        class="fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-gray-800 border-t-2 border-gray-200 dark:border-gray-700 shadow-2xl animate-slide-up"
      >
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div class="flex items-start gap-3 flex-1">
              ...
              >
                <path
                  d="M10 2a8 8 0 100 16 8 8 0 000-16zM9 9a1 1 0 112 0 1 1 0 01-2 0zm1-5a1 1 0 011 1v3a1 1 0 11-2 0V5a1 1 0 011-1z"
                />
              </svg>
              <div>
